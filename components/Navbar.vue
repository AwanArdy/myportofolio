<template>
    <nav class="fixed top-0 left-0 w-full backdrop-blur-lg bg-[#F8F8F8]/30 shadow-md z-50">
        <div class="container mx-auto flex justify-between items-center px-4 py-4 relative">
            <div class="text-2xl text-gray-800 font-bold"><a href="#hero">Awan Ardy</a></div>
            ...
            >
                <li class="py-4 sm:py-0 text-center"><a href="#about" class="hover:text-[#FF4B00] block" @click="closeMenu">About</a></li>
                <li class="py-4 sm:py-0 text-center"><a href="#projects" class="hover:text-[#FF4B00] block" @click="closeMenu">Portofolio</a></li>
                <li class="py-4 sm:py-0 text-center"><a href="#contact" class="hover:text-[#FF4B00] block" @click="closeMenu">Contact</a></li>
            </ul>
        </div>
    </nav>
</template>
